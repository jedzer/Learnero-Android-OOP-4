...
public class CourseDaoServer implements IUserDao {
    //TODO change to right IP
    private static final String URLish = "http://localhost:8000";
    private static final CourseDaoServer Instance = new CourseDaoServer();

    private CourseDaoServer() { };
    ...
    public static CourseDaoServer getInstance()
    {
        return Instance;
    }
