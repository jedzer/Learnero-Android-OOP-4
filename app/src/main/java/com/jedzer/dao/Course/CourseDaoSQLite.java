...
import com.jedzer.adapters.SQLiteCourse;
...
public class CourseDaoSQLite implements IUserDao {
    private static final CourseDaoSQLite Instance = new CourseDaoSQLite();

    private CourseDaoSQLite() { };

    public static CourseDaoSQLite getInstance()
    {
        return Instance;
    }
    ...
    public void save(User user) throws UserAlreadyCreatedException {
        SQLiteCourse squ = new SQLiteCourse(LearneroApp.getAppContext());
        SQLiteDatabase db;
        try
        {
    ...
    public User getByNickname(String login) throws UserNotFoundException {
        SQLiteCourse dbu = new SQLiteCourse(LearneroApp.getAppContext());
        SQLiteDatabase db;
        try {
